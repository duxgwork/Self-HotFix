...
public class ReflectUtils {
    ...
    public static Object getField(Object obj, Class<?> clazz, String field)
        ...
        Field locallField = clazz.getDeclaredField(field);
        locallField.setAccessible(true);
        return locallField.get(obj);
    }
    ...
    public static void setField(Object obj, Class<?> clazz, Object value)
            throws NoSuchFieldException, IllegalAccessException, IllegalArgumentException {
        Field locallField = clazz.getDeclaredField("dexElements");
        locallField.setAccessible(true);
        locallField.set(obj, value);
    }
